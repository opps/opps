...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'permissions_permission', (
        ...
        db.send_create_signal(u'permissions', ['Permission'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'permissions_permission')
    ...
    models = {
        ...
        u'permissions.permission': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mirror_site': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'permissions_permission_mirror_site'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['sites.Site']"}),
