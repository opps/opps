...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field channel on 'Permission'
        m2m_table_name = db.shorten_name(u'permissions_permission_channel')
        ...
        db.create_unique(m2m_table_name, ['permission_id', 'channel_id'])
