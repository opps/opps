...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PermissionGroup'
        db.create_table(u'permissions_permissiongroup', (
            ...
            ('channel_recursive', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'])),
        ))
        db.send_create_signal(u'permissions', ['PermissionGroup'])

        # Adding M2M table for field channel on 'PermissionGroup'
        m2m_table_name = db.shorten_name(u'permissions_permissiongroup_channel')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('permissiongroup', models.ForeignKey(orm[u'permissions.permissiongroup'], null=False)),
            ('channel', models.ForeignKey(orm[u'channels.channel'], null=False))
        ))
        db.create_unique(m2m_table_name, ['permissiongroup_id', 'channel_id'])

        # Adding M2M table for field site on 'PermissionGroup'
        m2m_table_name = db.shorten_name(u'permissions_permissiongroup_site')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('permissiongroup', models.ForeignKey(orm[u'permissions.permissiongroup'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['permissiongroup_id', 'site_id'])

        # Deleting field 'Permission.site_domain'
        db.delete_column(u'permissions_permission', 'site_domain')

        # Deleting field 'Permission.site'
        db.delete_column(u'permissions_permission', 'site_id')

        # Deleting field 'Permission.date_available'
        db.delete_column(u'permissions_permission', 'date_available')

        # Deleting field 'Permission.published'
        db.delete_column(u'permissions_permission', 'published')

        # Deleting field 'Permission.site_iid'
        db.delete_column(u'permissions_permission', 'site_iid')

        # Adding field 'Permission.channel_recursive'
        db.add_column(u'permissions_permission', 'channel_recursive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Removing M2M table for field mirror_site on 'Permission'
        db.delete_table(db.shorten_name(u'permissions_permission_mirror_site'))

        # Adding M2M table for field site on 'Permission'
        m2m_table_name = db.shorten_name(u'permissions_permission_site')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('permission', models.ForeignKey(orm[u'permissions.permission'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['permission_id', 'site_id'])


    def backwards(self, orm):
        # Deleting model 'PermissionGroup'
        db.delete_table(u'permissions_permissiongroup')

        # Removing M2M table for field channel on 'PermissionGroup'
        db.delete_table(db.shorten_name(u'permissions_permissiongroup_channel'))

        # Removing M2M table for field site on 'PermissionGroup'
        db.delete_table(db.shorten_name(u'permissions_permissiongroup_site'))

        # Adding field 'Permission.site_domain'
        db.add_column(u'permissions_permission', 'site_domain',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=100, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Permission.site'
        db.add_column(u'permissions_permission', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'Permission.date_available'
        db.add_column(u'permissions_permission', 'date_available',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Permission.published'
        db.add_column(u'permissions_permission', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Permission.site_iid'
        db.add_column(u'permissions_permission', 'site_iid',
                      self.gf('django.db.models.fields.PositiveIntegerField')(blank=True, max_length=4, null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'Permission.channel_recursive'
        db.delete_column(u'permissions_permission', 'channel_recursive')

        # Adding M2M table for field mirror_site on 'Permission'
        m2m_table_name = db.shorten_name(u'permissions_permission_mirror_site')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('permission', models.ForeignKey(orm[u'permissions.permission'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ...
        # Removing M2M table for field site on 'Permission'
        db.delete_table(db.shorten_name(u'permissions_permission_site'))
    ...
    models = {
        ...
        u'permissions.permission': {
            ...
            'channel': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['channels.Channel']", 'null': 'True', 'blank': 'True'}),
            'channel_recursive': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'date_insert': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_update': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'permissions.permissiongroup': {
            'Meta': {'object_name': 'PermissionGroup'},
            'channel': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['channels.Channel']", 'null': 'True', 'blank': 'True'}),
            'channel_recursive': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'date_insert': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_update': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
