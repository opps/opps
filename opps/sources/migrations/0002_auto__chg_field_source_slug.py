...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'sources_source', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=150))

    def backwards(self, orm):

        # Changing field 'Source.slug'
        db.alter_column(u'sources_source', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=140, unique=True))
