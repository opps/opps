...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.layout'
        db.add_column(u'channels_channel', 'layout',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=250, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.layout'
        db.delete_column(u'channels_channel', 'layout')
