...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ChannelConfig', fields ['date_available']
        db.create_index(u'channels_channelconfig', ['date_available'])

        # Adding index on 'ChannelConfig', fields ['published']
        db.create_index(u'channels_channelconfig', ['published'])

        # Adding index on 'Channel', fields ['date_available']
        db.create_index(u'channels_channel', ['date_available'])

        # Adding index on 'Channel', fields ['published']
        db.create_index(u'channels_channel', ['published'])


    def backwards(self, orm):
        # Removing index on 'Channel', fields ['published']
        db.delete_index(u'channels_channel', ['published'])

        # Removing index on 'Channel', fields ['date_available']
        db.delete_index(u'channels_channel', ['date_available'])

        # Removing index on 'ChannelConfig', fields ['published']
        db.delete_index(u'channels_channelconfig', ['published'])

        # Removing index on 'ChannelConfig', fields ['date_available']
        db.delete_index(u'channels_channelconfig', ['date_available'])
