...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.menu_url_target'
        db.add_column(u'channels_channel', 'menu_url_target',
                      self.gf('django.db.models.fields.CharField')(default=u'_self', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.menu_url_target'
        db.delete_column(u'channels_channel', 'menu_url_target')
    ...
    models = {
        ...
        u'channels.channel': {
            ...
            'menu_url_target': ('django.db.models.fields.CharField', [], {'default': "u'_self'", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
