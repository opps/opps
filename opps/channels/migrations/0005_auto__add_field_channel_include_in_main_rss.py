...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.include_in_main_rss'
        db.add_column(u'channels_channel', 'include_in_main_rss',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.include_in_main_rss'
        db.delete_column(u'channels_channel', 'include_in_main_rss')
