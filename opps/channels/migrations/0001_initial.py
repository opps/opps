...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ChannelConfig', fields ['key_group', 'key', 'site', 'channel', 'article']
        db.create_unique(u'channels_channelconfig', ['key_group', 'key', 'site_id', 'channel_id', 'article_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ChannelConfig', fields ['key_group', 'key', 'site', 'channel', 'article']
        db.delete_unique(u'channels_channelconfig', ['key_group', 'key', 'site_id', 'channel_id', 'article_id'])
    ...
    models = {
        ...
        u'channels.channelconfig': {
            'Meta': {'unique_together': "(('key_group', 'key', 'site', 'channel', 'article'),)", 'object_name': 'ChannelConfig'},
