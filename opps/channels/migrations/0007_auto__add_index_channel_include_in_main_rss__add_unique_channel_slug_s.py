...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Channel', fields ['include_in_main_rss']
        db.create_index(u'channels_channel', ['include_in_main_rss'])

        # Adding unique constraint on 'Channel', fields ['slug', 'site', 'parent', 'long_slug']
        db.create_unique(u'channels_channel', ['slug', 'site_id', 'parent_id', 'long_slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Channel', fields ['slug', 'site', 'parent', 'long_slug']
        db.delete_unique(u'channels_channel', ['slug', 'site_id', 'parent_id', 'long_slug'])

        # Removing index on 'Channel', fields ['include_in_main_rss']
        db.delete_index(u'channels_channel', ['include_in_main_rss'])
