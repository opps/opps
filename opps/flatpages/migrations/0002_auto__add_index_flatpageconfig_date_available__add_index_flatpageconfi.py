...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'FlatPageConfig', fields ['date_available']
        db.create_index(u'flatpages_flatpageconfig', ['date_available'])

        # Adding index on 'FlatPageConfig', fields ['published']
        db.create_index(u'flatpages_flatpageconfig', ['published'])


    def backwards(self, orm):
        # Removing index on 'FlatPageConfig', fields ['published']
        db.delete_index(u'flatpages_flatpageconfig', ['published'])

        # Removing index on 'FlatPageConfig', fields ['date_available']
        db.delete_index(u'flatpages_flatpageconfig', ['date_available'])
    ...
    models = {
       ...
       "%s.%s" % (User._meta.app_label, User._meta.module_name): {
        ...
        u'flatpages.flatpage': {
            'Meta': {'ordering': "['-date_available', 'title', 'channel_long_slug']", 'object_name': 'FlatPage', '_ormbases': [u'articles.Article']},
