...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlatPage.global_page'
        db.add_column(u'flatpages_flatpage', 'global_page',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FlatPage.global_page'
        db.delete_column(u'flatpages_flatpage', 'global_page')
    ...
    models = {
        ...
        u'flatpages.flatpage': {
            ...
            'global_page': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
