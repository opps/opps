...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'FlatPageConfig', fields ['key_group', 'key', 'site', 'channel', 'container']
        db.create_unique(u'flatpages_flatpageconfig', ['key_group', 'key', 'site_id', 'channel_id', 'container_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FlatPageConfig', fields ['key_group', 'key', 'site', 'channel', 'container']
        db.delete_unique(u'flatpages_flatpageconfig', ['key_group', 'key', 'site_id', 'channel_id', 'container_id'])
    ...
    models = {
        ...
        u'flatpages.flatpageconfig': {
            'Meta': {'unique_together': "(('key_group', 'key', 'site', 'channel', 'container'),)", 'object_name': 'FlatPageConfig'},
