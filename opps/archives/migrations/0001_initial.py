...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaggedArchive'
        db.create_table(u'archives_taggedarchive', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'archives_taggedarchive_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archives.Archive'])),
        ))
        db.send_create_signal(u'archives', ['TaggedArchive'])
    ...
    def backwards(self, orm):
        # Deleting model 'TaggedArchive'
        db.delete_table(u'archives_taggedarchive')
    ...
    models = {
        ...
        u'archives.taggedarchive': {
            'Meta': {'object_name': 'TaggedArchive'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['archives.Archive']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'archives_taggedarchive_items'", 'to': u"orm['taggit.Tag']"})
        },
        u'auth.group': {
