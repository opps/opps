...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.main_image_caption'
        db.alter_column(u'articles_article', 'main_image_caption', self.gf('django.db.models.fields.CharField')(max_length=4000, null=True))

        # Changing field 'ArticleImage.caption'
        db.alter_column(u'articles_articleimage', 'caption', self.gf('django.db.models.fields.CharField')(max_length=4000, null=True))

    def backwards(self, orm):

        # Changing field 'Article.main_image_caption'
        db.alter_column(u'articles_article', 'main_image_caption', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ArticleImage.caption'
        db.alter_column(u'articles_articleimage', 'caption', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
