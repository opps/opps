...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'articles_document', (
        ...
        db.send_create_signal(u'articles', ['Document'])


    def backwards(self, orm):
        # Deleting model 'Document'
        db.delete_table(u'articles_document')
    ...
    models = {
        ...
        u'articles.document': {
            'Meta': {'ordering': "['-date_available']", 'object_name': 'Document'},
