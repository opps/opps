...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Article', fields ['channel_long_slug', 'child_class', 'site', 'slug']
        db.create_unique(u'articles_article', ['channel_long_slug', 'child_class', 'site_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Article', fields ['channel_long_slug', 'child_class', 'site', 'slug']
        db.delete_unique(u'articles_article', ['channel_long_slug', 'child_class', 'site_id', 'slug'])
