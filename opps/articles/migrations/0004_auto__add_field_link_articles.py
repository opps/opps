...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Link.articles'
        db.add_column(u'articles_link', 'articles',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='link_article', null=True, to=orm['articles.Article']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Link.articles'
        db.delete_column(u'articles_link', 'articles_id')
