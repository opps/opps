...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.show_on_root_channel'
        db.add_column(u'articles_article', 'show_on_root_channel',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.show_on_root_channel'
        db.delete_column(u'articles_article', 'show_on_root_channel')
