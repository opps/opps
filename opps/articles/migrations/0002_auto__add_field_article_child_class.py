...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.child_class'
        db.add_column(u'articles_article', 'child_class',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.child_class'
        db.delete_column(u'articles_article', 'child_class')
