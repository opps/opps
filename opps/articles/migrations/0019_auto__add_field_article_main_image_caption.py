...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.main_image_caption'
        db.add_column(u'articles_article', 'main_image_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.main_image_caption'
        db.delete_column(u'articles_article', 'main_image_caption')
