...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.child_app_label'
        db.add_column(u'articles_article', 'child_app_label',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.child_app_label'
        db.delete_column(u'articles_article', 'child_app_label')
