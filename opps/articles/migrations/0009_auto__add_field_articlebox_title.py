...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleBox.title'
        db.add_column(u'articles_articlebox', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ArticleBox.title'
        db.delete_column(u'articles_articlebox', 'title')
    ...
    models = {
        ...
        u'articles.article': {
            'Meta': {'ordering': "['-date_available', 'title', 'channel_long_slug']", 'object_name': 'Article'},
