...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostRelated.related'
        db.alter_column(u'articles_postrelated', 'related_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['containers.Container']))

    def backwards(self, orm):

        # Changing field 'PostRelated.related'
        db.alter_column(u'articles_postrelated', 'related_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['articles.Post'], on_delete=models.SET_NULL))
