...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuerySet.channel'
        db.alter_column(u'boxes_queryset', 'channel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['channels.Channel'], null=True))

    def backwards(self, orm):

        # Changing field 'QuerySet.channel'
        db.alter_column(u'boxes_queryset', 'channel_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['channels.Channel']))
