...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DynamicBox.channel_name'
        db.add_column(u'boxes_dynamicbox', 'channel_name',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'DynamicBox.channel_long_slug'
        db.add_column(u'boxes_dynamicbox', 'channel_long_slug',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DynamicBox.channel_name'
        db.delete_column(u'boxes_dynamicbox', 'channel_name')

        # Deleting field 'DynamicBox.channel_long_slug'
        db.delete_column(u'boxes_dynamicbox', 'channel_long_slug')
