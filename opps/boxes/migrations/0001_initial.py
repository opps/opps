...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DynamicBox'
        db.create_table(u'boxes_dynamicbox', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_insert', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=User)),
            ...
            ('dynamicqueryset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['boxes.QuerySet'])),
        ))
        db.send_create_signal(u'boxes', ['DynamicBox'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DynamicBox'
        db.delete_table(u'boxes_dynamicbox')
