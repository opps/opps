...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notification.container'
        db.alter_column(u'notifications_notification', 'container_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['containers.Container'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Notification.container'
        raise RuntimeError("Cannot reverse this migration. 'Notification.container' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Notification.container'
        db.alter_column(u'notifications_notification', 'container_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['containers.Container']))
    ...
    models = {
        ...
        u'notifications.notification': {
            ...
            'container': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['containers.Container']", 'null': 'True', 'blank': 'True'}),
            'date_available': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'db_index': 'True'}),
            'date_insert': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_update': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
