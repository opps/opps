...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContainerBoxContainers.aggregate'
        db.add_column(u'containers_containerboxcontainers', 'aggregate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContainerBoxContainers.aggregate'
        db.delete_column(u'containers_containerboxcontainers', 'aggregate')
