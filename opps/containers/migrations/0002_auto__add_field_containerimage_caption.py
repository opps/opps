...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContainerImage.caption'
        db.add_column(u'containers_containerimage', 'caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContainerImage.caption'
        db.delete_column(u'containers_containerimage', 'caption')
