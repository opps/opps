...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Container.child_module'
        db.add_column(u'containers_container', 'child_module',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=120, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Container.child_module'
        db.delete_column(u'containers_container', 'child_module')
