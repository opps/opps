...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContainerRelated'
        db.create_table(u'containers_containerrelated', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('container', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='containerrelated_container', null=True, on_delete=models.SET_NULL, to=orm['containers.Container'])),
            ('related', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='containerrelated_related', null=True, on_delete=models.SET_NULL, to=orm['containers.Container'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'containers', ['ContainerRelated'])


    def backwards(self, orm):
        # Deleting model 'ContainerRelated'
        db.delete_table(u'containers_containerrelated')
    ...
    models = {
        ...
        u'containers.containerrelated': {
            ...
            'container': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'containerrelated_container'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['containers.Container']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'related': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'containerrelated_related'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['containers.Container']"})
        },
        u'containers.mirror': {
