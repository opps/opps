...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'containers.container': {
            ...
            'mirror_channel': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'containers_container_mirror_channel'", 'symmetrical': 'False', 'to': u"orm['channels.Channel']"}),
        ...
        u'containers.containerbox': {
            ...
            'date_update': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mirror_channel': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'containers_containerbox_mirror_channel'", 'symmetrical': 'False', 'to': u"orm['channels.Channel']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
