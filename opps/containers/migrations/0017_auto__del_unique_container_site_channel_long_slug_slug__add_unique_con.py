...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Container', fields ['site', 'channel', 'slug']
        db.create_unique(u'containers_container', ['site_id', 'channel_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Container', fields ['site', 'channel', 'slug']
        db.delete_unique(u'containers_container', ['site_id', 'channel_id', 'slug'])
