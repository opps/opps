...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContainerBoxContainers.title'
        db.add_column(u'containers_containerboxcontainers', 'title',
        ...
        # Adding field 'ContainerBoxContainers.main_image'
        db.add_column(u'containers_containerboxcontainers', 'main_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Image'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'ContainerBoxContainers.main_image_caption'
        db.add_column(u'containers_containerboxcontainers', 'main_image_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=4000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContainerBoxContainers.title'
        db.delete_column(u'containers_containerboxcontainers', 'title')

        # Deleting field 'ContainerBoxContainers.short_title'
        db.delete_column(u'containers_containerboxcontainers', 'short_title')

        # Deleting field 'ContainerBoxContainers.main_image'
        db.delete_column(u'containers_containerboxcontainers', 'main_image_id')

        # Deleting field 'ContainerBoxContainers.main_image_caption'
        db.delete_column(u'containers_containerboxcontainers', 'main_image_caption')
    ...
    models = {
        ...
        u'containers.container': {
            ...
            'main_image': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "u'containers_container_mainimage'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['images.Image']"}),
