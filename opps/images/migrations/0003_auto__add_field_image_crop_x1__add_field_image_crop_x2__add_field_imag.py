...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.crop_x1'
        db.add_column(u'images_image', 'crop_x1',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.crop_x2'
        db.add_column(u'images_image', 'crop_x2',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.crop_y1'
        db.add_column(u'images_image', 'crop_y1',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.crop_y2'
        db.add_column(u'images_image', 'crop_y2',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.crop_x1'
        db.delete_column(u'images_image', 'crop_x1')

        # Deleting field 'Image.crop_x2'
        db.delete_column(u'images_image', 'crop_x2')

        # Deleting field 'Image.crop_y1'
        db.delete_column(u'images_image', 'crop_y1')

        # Deleting field 'Image.crop_y2'
        db.delete_column(u'images_image', 'crop_y2')
