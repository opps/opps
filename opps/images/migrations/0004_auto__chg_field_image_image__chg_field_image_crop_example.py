...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'images_image', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Image.crop_example'
        db.alter_column(u'images_image', 'crop_example', self.gf('django.db.models.fields.CharField')(max_length=140, null=True))
