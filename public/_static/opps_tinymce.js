...
function CustomFileBrowser(field_name, url, type, win) {
    ...
    if (type == 'image'){
        var cmsURL = '/admin/images/image/?pop=oppseditor'
        selectfunction = function (path){
            ...
            try {
                ...
                window.document.getElementById(dm_selector).value = '300';
            } catch(err) {
                console.log(err);
            }
    ...
    if (type == 'media'){
        var cmsURL = '/admin/multimedias/video/?pop=oppseditor'
        selectfunction = function (){console.log('selecting')}
    }

    if (type == 'file'){
        var cmsURL = '/admin/archives/file/?pop=oppseditor'
        selectfunction = function (){console.log('selecting')}
    }
